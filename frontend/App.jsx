...
import NewTrialPlan from "./components/trials/NewTrialPlan";
import EditTrialPlan from "./components/trials/EditTrialPlan";
  ...
  return (
    <>
      <Routes>
        ...
        <Route path="/trials/new" element={<NewTrialPlan />} />
        <Route path="/trials/:id" element={<EditTrialPlan />} />
